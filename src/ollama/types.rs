...
///
/// Using an enum instead of raw strings prevents typos like `"usre"` and enables
/// exhaustive matching. Serde serializes the variant names as lowercase strings
/// to match the Ollama API format.
...
pub enum Role {
    ...
    Assistant,
    /// Output from a tool call, fed back to the model.
    Tool,
}
